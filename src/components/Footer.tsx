...
const Footer = () => {
  return (
    <footer className="relative bg-gradient-to-r from-black via-green-900 to-black text-white py-12 overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute bottom-20 right-1/4 w-32 h-32 bg-green-500/10 rounded-full blur-3xl"></div>
      <div className="absolute bottom-10 left-1/4 w-24 h-24 bg-green-400/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-8 relative z-10">
        ...
        <div className="mt-8 pt-8 border-t border-white/10 text-center">
          <p className="text-white/60 text-sm">
            &copy; {new Date().getFullYear()} Wilker Martins. Todos os direitos
            reservados.
            <span className="ml-2">Feito com Next.js e Tailwind CSS</span>
          </p>
        </div>
      </div>
    </footer>
